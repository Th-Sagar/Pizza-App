      ...
      <nav className=" container flex justify-between items-center  py-5">
        <div className=" flex items-center space-x-4">
          ...
          <Select>
            ...
            <SelectContent>
              <SelectItem value="chessy-delight">Chessey Delight</SelectItem>
        ...
        <div className="md:flex items-center hidden gap-x-4">
          ...
          <div className=" relative">
            ...
            <span className=" absolute -top-4 -right-5 h-6 flex w-6 items-center justify-center rounded-full bg-primary font-bold text-white">
              3
            </span>
          </div>
